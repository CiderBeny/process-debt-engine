...
const TRANSLATIONS = {
            en: {
                ...
                ctaBtn:           '🚀 Download Full Report →',
                ctaTitle:         'Get Your Full Report',
                ctaSubtitle:      'Enter your details and we\'ll generate a complete PDF report of your Process Debt analysis.',
                ctaEmailLabel:    'Email address *',
                ctaNameLabel:     'Name (optional)',
                ctaSubmit:        'Send Report →',
                ctaThanks:        'Thank you! Generating your report...',
                ctaEmailInvalid:  'Please enter a valid email address.',
                ctaPrivacyNote:  'Your email is stored locally and never sent anywhere. No spam, no marketing.',
                ...
                advancedTeamSizeLabel:  'Team Size (engineers)',
                ...
                cascadeMultHelper:    'Second-order downstream costs — rework, cascading delays, context-switching — as fraction of direct OPEX waste (0.0–0.3). Default 0.15.',
                ...
                formulaCascade: 'OPEX Waste × 0.15 — second-order costs (rework, context-switching, cascading delays) triggered by process inefficiency, not double-counting of direct waste',
...
recInnovation: (val) => `<strong style="color:var(--purple)">Innovation Lever:</strong> Debt backlog is blocking roadmap. Resolving it unlocks <strong>${PDE.formatCompactCurrency(val)}</strong> in project margin.`,
                ...
                sensSubtitle:   'Which inputs drive NPV Total Debt the most? Each bar shows the swing from a \u00B120% input change.',
                sensSortInfo:   'Sorted by impact (largest on top)',
                sensFormula:    'Each input is varied \u00B120% while holding others constant. Bars show the resulting swing in NPV Total Debt from the base value.',
            ...
            pl: {
                ...
                ctaBtn:           '🚀 Pobierz Pełny Raport →',
                ctaTitle:         'Odbierz Swój Pełny Raport',
                ctaSubtitle:      'Wpisz dane, a wygenerujemy kompletny raport PDF analizy Twojego długu procesowego.',
                ctaEmailLabel:    'Adres email *',
                ctaNameLabel:     'Imię (opcjonalnie)',
                ctaSubmit:        'Wyślij Raport →',
                ctaThanks:        'Dziękujemy! Generowanie raportu...',
                ctaEmailInvalid:  'Wpisz poprawny adres email.',
                ctaPrivacyNote:  'Twój e-mail jest przechowywany lokalnie i nigdzie nie wysyłany. Zero spamu, zero marketingu.',
                ...
                advancedTeamSizeLabel:  'Liczba Inżynierów',
                ...
                cascadeMultHelper:    'Koszty drugiego rzędu — przeróbki, opóźnienia kaskadowe, przełączanie kontekstu — jako ułamek bezpośredniego OPEX (0,0–0,3). Domyślnie 0,15.',
                ...
                formulaCascade: 'Marnotrawstwo OPEX × 0,15 — koszty drugiego rzędu (przeróbki, przełączanie kontekstu, opóźnienia kaskadowe) wywołane nieefektywnością, nie podwójne liczenie OPEX',
                ...
                methodologyCalibTitle: '16. Kalibracja Modelu',
                methodologyCalibBody:  'Panel Kalibracji Modelu pozwala porównać prognozy modelu z rzeczywistymi danymi kwartalnymi. Każdy wiersz metryki pokazuje: (1) Wartość przewidywaną — roczne oszacowanie modelu podzielone przez 4. (2) Wartość rzeczywistą — wpisaną przez użytkownika za dany kwartał. (3) Odchylenie — wartość rzeczywista minus przewidywana. (4) Δ% — (rzeczywista − przewidywana) / przewidywana × 100. (5) Plakietkę dokładności — zielona (błąd ≤15% — Dokładne), żółta (≤30% — Odchylone), czerwona (>30% — Słabe). Ogólny Wynik Dokładności uśrednia Δ% wszystkich metryk. Wartości rzeczywiste są zapisywane w localStorage i utrzymują się między sesjami. Użyj "Reset", aby wyczyścić wszystkie dane.',
                ...
                sensSubtitle:   'Które parametry mają największy wpływ na NPV Całkowitego Długu? Każdy słupek pokazuje wahanie przy zmianie inputu o ±20%.',
                sensSortInfo:   'Posortowane według wpływu (największy u góry)',
                sensFormula:    'Każdy parametr jest zmieniany o ±20% przy stałych pozostałych. Słupki pokazują zmianę NPV Całkowitego Długu względem wartości bazowej.',
                sensDownside:   'Spadek',
                sensUpside:     'Wzrost',
                sensLow:        'Niski',
                sensBase:       'Bazowy',
